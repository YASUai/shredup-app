      ...
      <div class="zone-left">
        ...
        <div class="left-block">
          ...
          <ul class="menu-list">
            ...
            <li class="menu-item" id="logs-btn">LOGS</li>
          ...
          <div class="session-save-container">
            <button class="save-session-btn-neumorph" onclick="downloadSessionReport()">
              <svg class="save-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M7 3V10H15" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              <span class="save-text">Sauvegarder Session</span>
            </button>
          </div>
        </div>
      </div>
